...
const game = {
    ...
    stop() {
        ...
        var message = "Игра окончена. Ваши очки " + game.counter
    ...
    moveSnake() {
        ...
        snake.render();
        var set = new Set(snake.parts.map(JSON.stringify))
        if (set.size != snake.parts.length){
...
//gameStop = document.getElementById("button-stop")
